...
export const metadata = {
  title: 'Bracelets | Anthony Laurence Jewelers',
  description: 'Shop our collection of fine bracelets — tennis bracelets, bangles, charm bracelets, and more in gold, silver, and platinum.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-10">
          ...
          <main className="flex-1 min-w-0">
            <ProductGrid products={products} emptyMessage="No bracelets found." />
          </main>
        </div>
      </div>
    </div>
